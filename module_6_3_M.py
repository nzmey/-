...
class Duckbill(Bird, AquaticAnimal, PoisonousAnimal, Animal):
    ...
    def __init__(self, name = 'Duckbill', sound = "Click-click-click", speed = 7):
        Animal.__init__(self, name , sound, speed)
        self.speak()
        self.bird_speak()
        self.lay_eggs()
...
# print(Duckbill.mro())
print('\nЭто - утконос - базовая версия...: -\n')
duck = Duckbill()

print('\nА это - уже другой утконос - с характером!!!...: -\n')
duck_arg = Duckbill('Утконос БОБА', 'КРЯ-КРЯ-КРЯ!!!')
